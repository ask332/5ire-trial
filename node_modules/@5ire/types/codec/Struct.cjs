...
function decodeStruct(registry, Types, value, jsonMap) {
  if ((0, _util.isU8a)(value)) {
    return (0, _index.decodeU8a)(registry, value, Types, decodeZip);
...
class Struct extends Map {
  ...
  constructor(registry, Types, value) {
    ...
    const [decoded, decodedLength] = decodeStruct(registry, (0, _index.mapToTypeMap)(registry, Types), value, jsonMap);
    super(decoded);
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _Types)[_Types] = (0, _index.mapToTypeMap)(registry, Types);
  }
