...
declare type ReturnCodec<F extends AnyFunction> = AsCodec<ObsInnerType<ReturnType<F>>>;
...
export declare type GenericStorageEntryFunction = (...args: unknown[]) => Observable<Codec>;
