...
function receivedHeartbeats(instanceId, api) {
  return (0, _index.memo)(instanceId, () => {
    ...
    return (_api$query$imOnline = api.query.imOnline) !== null && _api$query$imOnline !== void 0 && _api$query$imOnline.receivedHeartbeats ? api.derive.staking.overview().pipe((0, _rxjs.switchMap)(_ref2 => {
      let {
        currentIndex,
        validators
      } = _ref2;
