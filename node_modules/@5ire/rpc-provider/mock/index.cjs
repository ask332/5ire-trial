...
var _types = require("@5ire/types");

var _jsonrpc = _interopRequireDefault(require("@5ire/types/interfaces/jsonrpc"));

var _Header = _interopRequireDefault(require("@5ire/types-support/json/Header.004.json"));

var _SignedBlock004Immortal = _interopRequireDefault(require("@5ire/types-support/json/SignedBlock.004.immortal.json"));
