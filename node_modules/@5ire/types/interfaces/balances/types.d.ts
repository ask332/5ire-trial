import type { Enum, Set, Struct, U8aFixed } from '@5ire/types';
import type { Balance, BlockNumber, LockIdentifier } from '@5ire/types/interfaces/runtime';
/** @name AccountData */
...
export declare type PHANTOM_BALANCES = 'balances';
