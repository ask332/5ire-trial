...
import { compactFromU8a, compactToU8a, isHex, isU8a, logger, stringify, u8aConcat, u8aToHex, u8aToU8a } from '@5ire/util';
...
function decodeSetFromU8a(registry, ValClass, u8a) {
  ...
  const [values, decodedLength] = decodeU8a(registry, u8a.subarray(offset), new Array(length.toNumber()).fill(ValClass));
