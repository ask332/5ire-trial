...
export declare type DeriveEraValPrefs = Record<string, PalletStakingValidatorPrefs>;
...
export declare type DeriveEraValidatorExposure = Record<string, PalletStakingExposure>;
