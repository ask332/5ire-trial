...
export declare function decodeVec<T extends Codec>(registry: Registry, Type: Constructor<T>, value: Uint8Array | HexString | unknown[], length?: number): [T[], number, number];
/**
 * @name Vec
 * @description
