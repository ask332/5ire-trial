import type { Bytes, Enum, Option, PortableRegistry, Struct, Text, Type, Vec, bool, u8 } from '@5ire/types';
import type { Si1Field, Si1LookupTypeId, Si1Type, SiLookupTypeId } from '@5ire/types/interfaces/scaleInfo';
...
export declare type PHANTOM_METADATA = 'metadata';
