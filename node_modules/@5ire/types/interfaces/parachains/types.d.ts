import type { BTreeMap, BitVec, Bytes, Enum, Option, Struct, U8aFixed, Vec, bool, u32 } from '@5ire/types';
import type { Signature } from '@5ire/types/interfaces/extrinsics';
import type { AccountId, Balance, BalanceOf, BlockNumber, H256, Hash, Header, StorageProof, ValidatorId, Weight } from '@5ire/types/interfaces/runtime';
import type { MembershipProof, SessionIndex } from '@5ire/types/interfaces/session';
...
export declare type PHANTOM_PARACHAINS = 'parachains';
