...
function decodeOption(registry, typeName, value) {
  ...
  const Type = (0, _index.typeToConstructor)(registry, typeName); // eslint-disable-next-line @typescript-eslint/no-use-before-define
...
class Option {
  constructor(registry, typeName, value) {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _Type)[_Type] = (0, _index.typeToConstructor)(registry, typeName);
    ...
    if ((0, _classPrivateFieldLooseBase2.default)(this, _raw)[_raw].initialU8aLength) {
      (0, _classPrivateFieldLooseBase2.default)(this, _initialU8aLength)[_initialU8aLength] = 1 + (0, _classPrivateFieldLooseBase2.default)(this, _raw)[_raw].initialU8aLength;
    }
  }
