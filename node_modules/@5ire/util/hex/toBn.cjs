...
function hexToBn(value) {
  ...
  const _options = (0, _spread.objectSpread)({
    isLe: false,
    isNegative: false
  ...
  const bn = new _bn.BN((_options.isLe ? reverse(_value) : _value) || '00', 16); // fromTwos takes as parameter the number of bits, which is the hex length
  // multiplied by 4.
