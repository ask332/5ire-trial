...
import { BTreeMap, BTreeSet, CodecSet, Compact, DoNotConstruct, Enum, HashMap, Int, Option, Range, RangeInclusive, Result, Struct, Tuple, U8aFixed, UInt, Vec, VecFixed, WrapperOpaque } from "../codec/index.js";
...
const infoMapping = {
  ...
  [TypeDefInfo.WrapperOpaque]: (registry, value) => WrapperOpaque.with(getSubType(value))
};
