...
var _typesKnown = require("@5ire/types-known");
...
function compatType(compatTypes, _type) {
  ...
  const index = compatTypes.findIndex(_ref => {
    let {
      def
    } = _ref;
...
function createMapEntry(compatTypes, registry, sectionTypes, _ref11) {
  let {
    hashers,
    keys,
    value
...
function convertStorage(compatTypes, registry, _ref12, sectionTypes) {
  let {
    items,
    prefix
  } = _ref12;
...
function createPallet(compatTypes, registry, mod, _ref15) {
  let {
    calls,
    constants,
    errors,
