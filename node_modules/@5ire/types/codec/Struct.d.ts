...
export declare class Struct<S extends TypesDef = TypesDef, V extends {
    ...
    constructor(registry: Registry, Types: S, value?: V | Map<unknown, unknown> | unknown[] | HexString | null, jsonMap?: Map<string, string>);
    static with<S extends TypesDef>(Types: S, jsonMap?: Map<string, string>): Constructor<Struct<S>>;
    /**
