...
export declare type DeriveHeartbeats = Record<string, DeriveHeartbeatAuthor>;
export interface RecentlyOffline {
    blockNumber: BlockNumber;
    count: BN;
}
export declare type DeriveRecentlyOffline = Record<string, RecentlyOffline[]>;
...
export declare type DeriveVoterPositions = Record<string, VoterPosition>;
