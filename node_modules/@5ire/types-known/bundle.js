...
import { bnToBn, isNull, isUndefined, objectSpread } from '@5ire/util';
...
export { mapXcmTypes } from "./xcm.js"; // flatten a VersionedType[] into a Record<string, string>
...
export function getModuleTypes({
  ...
  return objectSpread({}, typesModules[section], (_knownTypes$typesAlia = knownTypes.typesAlias) === null || _knownTypes$typesAlia === void 0 ? void 0 : _knownTypes$typesAlia[section]);
}
/**
