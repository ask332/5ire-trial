import type { Enum, Struct, Vec, u32 } from '@5ire/types';
import type { AccountId, BlockNumber } from '@5ire/types/interfaces/runtime';
...
export declare type PHANTOM_COLLECTIVE = 'collective';
